import { Col, ConfigProvider, Row, Card, Breadcrumb, Image, /* List, */Divider, Avatar, Tag, Badge } from 'antd';
                ...
                <Col xs={{ flex: "100%" }} xl={{ flex: "100%" }}>
                    <Card className="gobierno-card">
                        <div className="section-header">
                            <h2 className="tituloCartas">Integrantes del Honorable Cabildo</h2>
                                    ...
                                    >
                                        <div className="funcionario-content">
                                            <div className="foto-container">
                                                ...
                                                />
                                                <Badge
                                                    count={<Tag color="#f26c0d" style={{ borderRadius: "12px", fontSize: "10px" }}>Regidor</Tag>}
                                                    offset={[10, 10]}
                                                />
                                            </div>
                                            <div className="funcionario-info">
                                                <h4 className="tituloPuestos-elegante">{itegrante.puesto}</h4>
                                                <p className="nombreFuncionario">{itegrante.nombre}</p>
                                            </div>
                                        </div>
                                    </Card>
                                </Col>
