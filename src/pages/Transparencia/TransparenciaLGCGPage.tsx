...
import { TablaInfoLGCGAnual } from './Tablas/TablaInfoLGCGAnual';
import { TablaInfoLGCGTrimestral } from './Tablas/TablaInfoLGCGTrimestral';


export default function TransparenciaLGCGPage() {

    const items: TabsProps['items'] = [
        {
            key: '1',
            label: 'Anual',
            children: <TablaInfoLGCGAnual />,
        },
        {
            key: '2',
            label: 'Trimestral',
            children: <TablaInfoLGCGTrimestral/>,
        },
        {
            key: '3',
            label: 'Semestral',
